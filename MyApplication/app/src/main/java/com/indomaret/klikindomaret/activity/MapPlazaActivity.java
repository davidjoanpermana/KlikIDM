...
public class MapPlazaActivity extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback,
    ...
    private String storeNameString, type;
    private String store = "";
    private String latitude = "";
    private String longitude = "";
    private String storeCode = "";
    private String storeCodeString = "";
    private boolean isChangeStoreLocation, isDeliveryOrder, isIPP;
    ...
    private JSONObject lastStore = new JSONObject();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_map_plaza);
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                jsonArrayRequest(API.getInstance().getApiIPPGetStoreByRegion() + "?Lat="+latitude +"&Long="+longitude, "getStore");
            }
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                if (newText.length() >= 4) {
                    ...
                    jsonArrayRequest(API.getInstance().getApiIPPGetListStore() + "?StoreCode="+newText, "getListStore");
                } else {
                    searchListview.setVisibility(View.GONE);
                }
    ...
    public void jsonArrayRequest(String url, final String type){
        ...
        JsonArrayRequest jsonArrayReq = new JsonArrayRequest(url,
                    ...
                    public void onResponse(JSONArray response) {
                        if (type.equalsIgnoreCase("getStore")) {
                            ...
                            if (response.length() > 0){
                                ...
                                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MapPlazaActivity.this);
                                alertDialogBuilder.setTitle("KlikIndomaret");
                                alertDialogBuilder.setMessage("Mohon maaf area belum tercover");
                            ...
                            try {
                                ...
                                searchListview.setLayoutManager(new LinearLayoutManager(MapPlazaActivity.this));

                                AutoCompleteAdapter areaAutoCompleteAdapter = new AutoCompleteAdapter(MapPlazaActivity.this, listStore, "plaza");
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MapPlazaActivity.this, "Gagal terkoneksi server", Toast.LENGTH_LONG).show();
                preloader.setVisibility(View.GONE);
            }
        }, this);
    ...
    public void setSearchStoreCode(String value){
        ...
        jsonArrayRequest(API.getInstance().getApiIPPGetStoreByStoreCodeIppStore() + "?StoreCode="+searchView.getQuery(), "getStoreByCode");
    }
        ...
        try {
            if (response.getJSONObject(0).isNull("CustomerAddress")){
                ...
                if (response.getJSONObject(0).getJSONObject("CustomerAddress").getString("ID") != null &&
                    ...
                    sessionManager.setKeyPlazaAddressId(response.getJSONObject(0).getJSONObject("CustomerAddress").getString("ID"));
                }
            }
            ...
            if (ippStoreList.length() > 0) {
                        ...
                        if (type.equals("lastStore")){
                            ...
                            if (storeCodeString.length() > 0){
                                if (ippStoreList.getJSONObject(i).getString("ID").equals(storeCodeString)){
                                    ...
                                    infoListStore.setLayoutManager(new LinearLayoutManager(this));

                                    InfoListStoreAdapter autoCompleteAdapter = new InfoListStoreAdapter(this, ippStoreList, i+"", "plaza");
                ...
                if (!selected){
                    if (type.equals("wilayah") || type.equals("toko")){
                        InfoListStoreAdapter autoCompleteAdapter = new InfoListStoreAdapter(this, ippStoreList, "", "plaza");
                        infoListStore.setAdapter(autoCompleteAdapter);
                    }else{
                        InfoListStoreAdapter autoCompleteAdapter = new InfoListStoreAdapter(this, ippStoreList, "", "plaza");
                        infoListStore.setAdapter(autoCompleteAdapter);
    ...
    private void checkCostDelivery(String storeCode, String customerAddressId) {
        if (!TextUtils.isEmpty(storeCode)) {//diambil
            jsonArrayRequest(API.getInstance().getApiShippingMethod() + "?id=" + sessionManager.getCartId()
                    ...
                    + "&IsIPP=true&IPPServiceType=1&IPPStoreCode=" + storeCode, "checkCostStore");
            ...
            jsonArrayRequest(API.getInstance().getApiShippingMethod() + "?id=" + sessionManager.getCartId()
                    ...
                    + "&mfp_id=" + sessionManager.getKeyMfpId()
                    + "&IsIPP=" + true
                    + "&IPPServiceType=3&CustomerAddressID=" + customerAddressId, "checkCostDelivery");
        }
    }
    ...
    public void onResult(@NonNull LocationSettingsResult locationSettingsResult) {
        ...
        switch (status.getStatusCode()) {
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                try {
                    status.startResolutionForResult(MapPlazaActivity.this, REQUEST_CHECK_SETTINGS);
...
//        mMap.setInfoWindowAdapter(new POIInfoWindowAdapter(this));
                                ...
                                for (int i = 0; i < ippStoreList.length(); i++) {
                                    try {
                                        if (currentMarker.getPosition().latitude == ippStoreList.getJSONObject(i).getDouble("lat")
                                            ...
                                            infoListStore.setHasFixedSize(true);
                                            infoListStore.setLayoutManager(new LinearLayoutManager(MapPlazaActivity.this));

                                            InfoListStoreAdapter autoCompleteAdapter = new InfoListStoreAdapter(MapPlazaActivity.this, ippStoreList, i + "", "plaza");
                                            infoListStore.setAdapter(autoCompleteAdapter);
                                            autoCompleteAdapter.notifyDataSetChanged();

                                            storeCode = ippStoreList.getJSONObject(i).getString("ID");
                                            store = ippStoreList.getJSONObject(i).toString();
                                        }
                                    } catch (JSONException e) {
                                        e.printStackTrace();
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                try {
                    ...
                    storeObejct.put("StoreName", storeObejct.getString("store"));
                    storeObejct.put("StoreCode", storeObejct.getString("ID"));
                    storeObejct.put("Address", storeObejct.getString("address"));
                    sessionManager.setKeyLastStorePlaza(storeObejct.toString());
                } catch (JSONException e) {
                    e.printStackTrace();
                }
